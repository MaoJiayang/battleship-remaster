...
| 档位 | `hitFocus` | `sonarFocus` | `airstrikeAdvantage` | `sonarEntropyGate` | `randomness` | 特性描述 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **EASY** | 0.3 | 0.2 | 1.5 | 0.30 | 0.5 | 主要随机射击，几乎不连线、不侦查 |
| **NORMAL** | 2.0 | 1.2 | 1.1 | 0.15 | 0.3 | 具备连线意识，偶尔侦查，存在失误 |
| **HARD** *(默认)* | 5.5 | 2.0 | 0.85 | 0.05 | 0.0 | 完全理性，紧抓命中并积极侦查 |
